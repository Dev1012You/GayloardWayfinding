...
//
//  Created by John Pacheco on 4/4/15.
...
extern NSString *const kAccessibleOnlyDirections;
...
extern NSString *const kGAHLocationImageURL;
...
#define kTan UIColorFromRGB(0xbb9468)
#define kBlueGaylord UIColorFromRGB(0x033074)
#define kGrayDark UIColorFromRGB(0x646464)
